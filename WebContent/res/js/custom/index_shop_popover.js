...
$('document').ready(function(){
    ...
    $('#shopPopPanel_4').popover({"trigger" : "hover","html" : true,"content" : contentArr[4]});
    ...
    $('#shopPopPanel_8').popover({"trigger" : "hover","html" : true,"content" : contentArr[8]});
    ...
    $('#shopPopPanel_12').popover({"trigger" : "hover","html" : true,"content" : contentArr[12]});
    ...
    $('#callPopPanel_4').popover({"trigger" : "hover","html" : true,"content" : callContentArr[4]});
    ...
    $('#callPopPanel_8').popover({"trigger" : "hover","html" : true,"content" : callContentArr[8]});
    ...
    $('#callPopPanel_12').popover({"trigger" : "hover","html" : true,"content" : callContentArr[12]});
