            ...
            <div>
                <ul>
                    <li>
                        ...
                        <button type="button" class="btn btn-info">账号信息</button>
                        <button type="button" class="btn btn-info">历史订单</button>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div>
        ...
        <div>
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div>
                        <button class="btn btn-danger">一键确认审核</button>
                        <button class="btn btn-danger">一键确认领取</button>
                    </div>
                    <p>
                    <div>
                        <table class="table table-responsive table-bordered">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-primary btn-sm">确认审核</button> <button class="btn btn-primary btn-sm">拒绝</button></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>JOE</td>
                                ...
                                <td><button class="btn btn-success btn-sm">确认领取</button></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>JOE</td>
                                ...
                                <td><button class="btn btn-danger btn-sm" disabled>订单结束</button></td>
                            </tr>
                        </table>
