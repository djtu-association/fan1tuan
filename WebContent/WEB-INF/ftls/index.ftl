    ...
    <div class="CartContent">
    	<div class="row-fluid">
    		<div class="span5 text-center">
        		<img style="width: 64px;height: 64px" alt="Generic placeholder image" src="res/images/shop-image.jpeg" title="52a6ac98c0939676d0180f07" class="img-thumbnail">
    			<span class="badge badge-success">￥12</span>
    		</div>
    		<div class="span7">
        		<p style="font-size:15px">蔬菜拌饭<br><i class="icon-d-star s6"></i></p>
        		
        		<a title="进入菜品所在店铺" data-toggle="Enter the shop" href="#" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-home"></span></a>
    			<a class="btn btn-success btn-sm" href="javascript:void(0)" onclick="addToShoppingCart()" title="加入购物车"><span class="glyphicon glyphicon-cutlery"></span></a>
...
<div class="jumbotron"  style="height: 300px">
    ...
    <div style="text-align: center">
    	<h3><label class="text text-danger">
    		<span class="glyphicon glyphicon-shopping-cart"></span></label>现在就去订餐
    	</h3>
    </div>
    <br/>
    <div class="row-fluid">
    	<div class="span1"></div>
   		<div class="span5"><button class="btn btn-large btn-block btn-primary" type="button" id="toOnline" data-toggle="tooltip" title="不同再找小广告，不用再打电话，直接就可以在这里订餐哦"><span class="feature-heading lead">在线订餐</span></button></div>
    	<div class="span5"><button class="btn btn-large btn-block btn-danger" type="button" id="toPhone" data-toggle="tooltip" title="我们会给您提供他们的电话，您还可以亲自打电话订餐哦"><span class="feature-heading lead">电话订餐</span></button></div>
	    <div class="span1"></div>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            <div class="panel panel-default">
                <!--<div class="panel-heading span12" >
                    <div class="span4">
                        <label class="label label-warning">热门推荐</label>
                        <label class="label label-danger">时刻更新最新动态</label>
                    </div>
                    <div class="span8" style="text-align: right">
                        <a href="javascript:void(0)" id="nextContents" class="btn btn-info btn-sm">换一组</a>
                    </div>
                </div>-->
                <div class="panel-body">
                    <div class="row-fluid">
                        ...
                        <div class="span4">
                        	<button class="btn btn-info btn-lg toOnline"><h1 class="feature-heading">Let's Have 饭</h1></a>
                        </div>
            ...
            <div class="navbar navbar-inverse onlinePin">
                ...
                <div  class="navbar-collapse collapse">
                    <ul class="nav">
                        ...
                        <!--
                        <li class="active"  id="navWeekStar">
                            <a href="#fakelink" onclick="week_AjaxRefreshWeekStar()">
                                每周之星
                            </a>
                        </li>
                        -->
    ...
    <div class="row-fluid">
        <div class="span1" >
            <div class="row-fluid" id="weekStarTrigger">
                <div class="span10">
                	<button class="btn btn-primary btn-lg" style="margin-top:150px"><i class="fui-arrow-right"></i><br>周榜</button>
                </div>
                <div class="span2">
                </div>
            </div>
        ...
        <div class="span10" style="height: 600px">
            ...
            <div class="panel-heading" style="height: 58px">
                ...
                <div class="col-lg-3">
                    <div class="btn-group">
                    	<select id="sel_shop_taste" multiple="multiple" title="选择口味" onchange="index_ChangeHiddenSelTaste(this,1);shop_AjaxChange(0);">
                ...
                <div class="col-lg-6 pull-right">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-primary">
                            <input type="radio" name="options1" id="option1" value="0" onchange="javascript:index_ChangeHiddenAccord(1,0);shop_AjaxChange(0);"> 人气 <span class="glyphicon glyphicon-sort-by-attributes"></span>
                        </label>
                        <label class="btn btn-primary">
                            <input type="radio" name="options1" id="option2" value="1" onchange="javascript:index_ChangeHiddenAccord(1,1);shop_AjaxChange(0);"> 销量 <span class="glyphicon glyphicon-sort-by-attributes"></span>
                        </label>
                        <label class="btn btn-primary">
                            <input type="radio" name="options1" id="option3" value="2" onchange="javascript:index_ChangeHiddenAccord(1,2);shop_AjaxChange(0);"> 评分 <span class="glyphicon glyphicon-sort-by-attributes"></span>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-heading" style="height: 58px">
                ...
                <div class="span6 pull-right">
                    <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-primary">
                            <input type="radio" name="options" id="dish_option1" value="0" onchange="javascript:index_ChangeHiddenAccord(2,0);dish_AjaxChange(0);"> 人气 <span class="glyphicon glyphicon-sort-by-attributes"></span>
                        </label>
                        <label class="btn btn-primary">
                            <input type="radio" name="options" id="dish_option2" value="1" onchange="javascript:index_ChangeHiddenAccord(2,1);dish_AjaxChange(0);"> 销量 <span class="glyphicon glyphicon-sort-by-attributes"></span>
                        </label>
                        <label class="btn btn-primary">
                            <input type="radio" name="options" id="dish_option3" value="2" onchange="javascript:index_ChangeHiddenAccord(2,2);dish_AjaxChange(0);"> 评分 <span class="glyphicon glyphicon-sort-by-attributes"></span>
                        </label>
                    </div>
                </div>
            </div>
...
<div class="container" id="phoneCallPart">
    ...
    <div class="row-fluid" style="height: 800px">
        ...
        <div class="panel-heading" style="height: 58px">
            ...
            <div class="span3">
                <select id="sel_call_taste" multiple="multiple" title="选择口味" onchange="index_ChangeHiddenSelTaste(this,3);">
                    <#list shopTasteTags as tags>
                    <option value="${tags.id}">${tags.name}</option>
                    </#list>
                </select>
