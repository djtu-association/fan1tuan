						<#if Session["login"]?exists && Session["login"]["loginStatus"]?exists && Session["login"]["loginStatus"]=="1">
							<li class="dropdown">
                  				...
                  				<ul class="dropdown-menu dropdown-inverse">
                    				...
                    				<li class="divider"></li>
                    				<li><a href="javascript:void(0)" id="logout"><i class="glyphicon glyphicon-off"></i>&nbsp;&nbsp;&nbsp;退出登录</a></li>
                  				</ul>
                			</li>
                    		<li><a href="#"><i class="glyphicon glyphicon-list-alt"></i> 订单动态 <span class="badge badge-success">2</span></a></li>
                    	<#else>
	                        <li><a href="javascript:void(0)" onclick="location='signin.f1t'"><span class="glyphicon glyphicon-user"></span> 登陆</a></li>
	                        <li><a href="javascript:void(0)" onclick="location='signup.f1t'"><span class="glyphicon glyphicon-check"></span> 注册  </a></li>
                        </#if>