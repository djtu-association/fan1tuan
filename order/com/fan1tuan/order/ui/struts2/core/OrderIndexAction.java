...
public class OrderIndexAction extends ActionSupport implements SessionAware{
	/**
	 * 
	 */
	...
	//根据userId,获取一个买家在在多个商店购买的多个菜品,返回shopItem
		...
		{
			userId = "529e7c41b7b3d3a544110d88";
			setShopItems((ArrayList<ShopItem>) shoppingCartService.getShopItemByUserId(userId));
			ArrayList<ShopItem> shopItemsLocal = (ArrayList<ShopItem>) shoppingCartService.getShopItemByUserId(userId);
			return Action.SUCCESS;

		  
		}
		
		public String shopOrderSubmit()
		{
		  return Action.SUCCESS;		
		}
