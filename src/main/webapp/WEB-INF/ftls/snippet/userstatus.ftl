...
<li class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-inverse">
        ...
        <li><a href="/user/index.f1t#orders"><i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;&nbsp;已下的饿单</a>
        </li>
        <li><a href="/user/index.f1t#comments"><i class="glyphicon glyphicon-thumbs-up"></i>&nbsp;&nbsp;&nbsp;已下的评价</a>
        </li>
        ...
        <li class="divider"></li>
        <li><a class="need-redirect" href="javascript:void(0)" onclick="location='/signout.f1t'" id="logout"><i
                class="glyphicon glyphicon-off"></i>&nbsp;&nbsp;&nbsp;退出登录</a></li>
    </ul>
</li>
<li>
    <a id="pendingOrder" href="#fan1tuanModal" role="button"><i class="glyphicon glyphicon-list-alt"></i> 订单动态 <span
...
<#else>
<li><a class="need-redirect" href="javascript:void(0)" onclick="location='/secure/signin.f1t'"><span
        class="glyphicon glyphicon-user"></span> 登陆</a></li>
<li><a class="need-redirect" href="javascript:void(0)" onclick="location='/secure/signup.f1t'"><span
