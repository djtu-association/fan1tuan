...
public class ProjectCOLAnalyser {
	public static void main(String[] args) throws Exception{
		...
		String[] sourceFolders = {"search","order","shop","user","rank","general","life","WebContent/WEB-INF","WebContent/res/css/custom","WebContent/res/js/custom"};
			...
			File[] files = file.listFiles(new FileFilter() {
				...
				public boolean accept(File pathname) {
					if(pathname.isDirectory()&&!pathname.getName().equals("lib")){
						...
						if(extName.equals("java")||extName.equals("xml")||extName.equals("html")||extName.equals("ftl")||extName.equals("css")||extName.equals("js")){
							return true;
						}
					}
					return false;
